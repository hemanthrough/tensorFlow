...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 19 22:45:57 2018
...
with graph.as_default():
  ...
  weights = tf.Variable(
    tf.truncated_normal([image_size * image_size, 100]))
  biases = tf.Variable(tf.zeros([100]))
  weights2 = tf.Variable(tf.truncated_normal([100, num_labels]))
...
#  logits2 = tf.layers.dense(logits,10,tf.nn.relu)+100
